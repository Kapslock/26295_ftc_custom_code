...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -6.693; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -0.63; // x position of the perpendicular encoder (in tick units)
    }
