...
public class Test4_Specimen_Auto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        clippingSpecimen1 = drive.actionBuilder(drive.localizer.getPose())//(new Pose2d(0,-48,Math.toRadians(90)))
...
//                .strafeToLinearHeading(new Vector2d(44.72,-50.59), Math.toRadians(-45), new TranslationalVelConstraint(25))
        ...
        wristDownWait1 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.2)
                .build();
        wristDownWait2 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.2)
                .build();
        wristDownWait3 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.2)
                .build();
        wristDownWait4 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.2)
                .build();
        ...
        viperInWait1 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.75)
                .build();
        viperInWait2 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.75)
                .build();
        viperInWait3 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.75)
                .build();
        viperInWait4 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.75)
                .build();

        sampleTurnWait1 = drive.actionBuilder(drive.localizer.getPose())
                .waitSeconds(0.75)
                .build();
