...
public class RedBasketPose {
    ...
    public final static Pose2d inner_sample = new Pose2d(-42.60, -43.59, Math.toRadians(102.8)); //inner closest to center
    public final static Pose2d middle_sample = new Pose2d(-49.70, -43.05, Math.toRadians(113.59));
    public final static Pose2d outer_sample = new Pose2d(-53.65, -40.50, Math.toRadians(127.75)); //outer closest to wall
